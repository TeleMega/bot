local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = '<b>bot has been added ✅ in Group</b> <code>' ..msg.to.title..'</code>'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = '<b>bot has been removed ❎ in Group</b> <code>' ..msg.to.title..'</code>'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_lang then
   ...
   return reply_msg(msg.id,'<b>🔐Link Posting is already Unlocked🔓</b>', ok_cb, false)
    end
    end
  ...
  if group_lang then
   ...
   return reply_msg(msg.id,'<b>🔐Link Posting Hasbeen unLocked🔓</b>', ok_cb, false)
  end
end
...
local function lock_group_cmds(msg, data, target)
  ...
  if group_lang then
   return '🔒قفل دستورات بسته بود🔒'
    ...
    return '<b>🔐cmds Posting is already locked🔒</b>'
    end
    end
  ...
  if group_lang then
    ...
    return '<b>🔐cmds Posting Has Been Locked🔒</b>'
  end
end
...
local function unlock_group_cmds(msg, data, target)
  ...
  if group_lang then
    ...
    return '<b>🔐cmds Posting is already Unlocked🔓</b>'
    end
    end
  ...
  if group_lang then
    return '🔒قفل دستورات فعال شد🔓'
     ...
     return '<b>🔐cmds Posting Hasbeen unLocked🔓</b>'
  end
end 
...
local function unlock_group_operator(msg, data, target)
  ...
  return ' 🔐قُفل تبلیغات شارژ(ایرانسل،همراه،رایتل)غیرفعال بود🔒'
    ...
    return '<b>🔓Operator is not locked🔓'
  end
  end
...
local function lock_group_english(msg, data, target)
  ...
  return '🔐قُفل چَت ڪږدڹ بہ زبان انگلیسے فعال بود🔒'
    ...
    return '🔒English is already locked🔒</b>'
  end
  end
...
local function unlock_group_emoji(msg, data, target)
  ...
  local group_lang = redis:hget(hash,'lang')
  if group_lang then
    return '<b>🔓قـفـل اموجی در سـوپـرگـروه از قـبـل غـیـرفـعـال بـوده🔓'
  else
...
local function lock_group_spam(msg, data, target)
  ...
  if not is_owner(msg) then
    return "<b> 🔒قُفل اِسپَم دَږ سۅپږگږۅہ فعاڶ شد🔐 "
  end
  ...
  return '<b>🔒spam posting is already locked🔒</b>'
  end
  end
  ...
  if group_lang then
    ...
    return '<b>🔒spam posting hasBeen locked🔒</b>'
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  return '<b>🔒spam posting is already Unlocked🔓</b>'
  end
  end
  ...
  if group_lang then
    ...
    return '<b>🔒spam posting HasBeen Unlocked🔓</b>'
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  return '<b>🔒arabic posting is already locked🔒</b>'
  end
  end
  ...
  if group_lang then
    ...
    return '<b>🔒arabic posting hasBeen locked🔒</b>'
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  return '<b>🔒arabic posting is already Unlocked🔓</b>'
  end
  end
  ...
  if group_lang then
    ...
    return '<b>🔒arabic posting HasBeen Unlocked🔓</b>'
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  return ' <b>🔒addMember is already locked🔒</b>'
  end
  end
  ...
  return '<b>🔒addMember HasBeen locked🔒</b>'
end
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  return '<b>🔓AddMember is not locked🔓</b>'
  end
  end
  ...
  if group_lang then
    ...
    return ' <b>🔓AddMember hasBeen UNlocked🔓</b>'
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_lang then
    ...
    return '<b>🔒sticker posting HasBeen locked🔒</b>'
  end
end
local function unlock_group_sticker(msg, data, target)
  ...
  if group_lang then
    ...
    return '<b>🔒sticker posting HasBeen Unlocked🔓</b>'
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_lang then
    ...
    return ' <b>🔒Contact posting HasBeen locked🔒</b>'
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  local group_lang = redis:hget(hash,'lang')
  if group_lang then
    return '<b>🔒قفل اږسالہ کانتڪت دږ سۅپږگږۅه از قبڶ غیږ فعاڶ شڍه بۅڍ🔓</b>'
  else
  ...
  local group_lang = redis:hget(hash,'lang')
  if group_lang then
    return '<b>🔒قفل اږسالہ کانتڪت دږ سۅپږگږۅه غیږ فعاڶ شڍ🔓</b>'
    else
    return '<b> 🔒contact posting HasBeen Unlocked🔓</b>'
  end
end
...
local function modlist(msg)
  ...
  if next(data[tostring(msg.to.id)]['moderators']) == nil then
    return 'nomoderator in this group.'
  end
  local i = 1
...
local function in_channel_cb(cb_extra, success, result)
  ...
  if member then
    text = 'nouser @'..member..' in this SuperGroup.'
  else
    text = 'nouser ['..memberid..'] in this SuperGroup.'
  end
   ...
   rem_mutes(msg.to.id)
		...
		if matches[1] == "owner" or matches[1] =="ایدی صاحب" then
			...
			if not group_owner then
				return "noowner,ask admins in support groups to set owner for your SuperGroup"
			end
	...
	reply_msg(msg.id, text, ok_cb, false)
		...
		if matches[1] == 'clean'or matches[1] =='حذف' then
			...
			if matches[2] == 'modlist'or matches[2] =='مدیران' then
				if next(data[tostring(msg.to.id)]['moderators']) == nil then
					return 'nomoderator(s) in this SuperGroup.'
				end
				for k,v in pairs(data[tostring(msg.to.id)]['moderators']) do
